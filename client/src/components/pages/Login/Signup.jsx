...
function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateEmail(email)) {
            axios.post('http://localhost:3000/signin', { name, email, password, dob })
                .then(result => {
            ...
            Swal.fire({
                title: `Your email should be of a certain domain "@technix-technology.com" `,
            ...
            <div className='container'>
                ...
                <div className="form-content-right">
                    ...
                    <form onSubmit={handleSubmit} className="form">
                        <h1 style={{ fontSize: "35px", marginBottom: "0" }}>Sign In</h1>
                        ...
                        <div className="form-group">
                            <label htmlFor="password_verify" className="form-label">Retype password: </label>
                            <input
                                type={
                                    showPassword ? "text" : "password"}
